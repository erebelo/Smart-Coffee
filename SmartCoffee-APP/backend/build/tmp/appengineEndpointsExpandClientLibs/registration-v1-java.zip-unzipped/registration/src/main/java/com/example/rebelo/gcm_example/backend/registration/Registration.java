 ...
 * on 2016-06-10 at 20:01:33 UTC 
 * Modify at your own risk.
 */

package com.example.rebelo.gcm_example.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<com.example.rebelo.gcm_example.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.example.rebelo.gcm_example.backend.registration.model.CollectionResponseRegistrationRecord.class);
  ...
  /**
   * Create a request for the method "reigster".
   *
   * This request holds the parameters needed by the registration server.  After setting any optional
   * parameters, call the {@link Reigster#execute()} method to invoke the remote operation.
   *
   * @param regId
   * @return the request
   */
  public Reigster reigster(java.lang.String regId) throws java.io.IOException {
    Reigster result = new Reigster(regId);
    initialize(result);
    return result;
  }

  public class Reigster extends RegistrationRequest<Void> {

    private static final String REST_PATH = "reigster";

    /**
     * Create a request for the method "reigster".
     *
     * This request holds the parameters needed by the the registration server.  After setting any
     * optional parameters, call the {@link Reigster#execute()} method to invoke the remote operation.
     * <p> {@link
     * Reigster#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param regId
     * @since 1.13
     */
    protected Reigster(java.lang.String regId) {
    ...
    @Override
    public Reigster setAlt(java.lang.String alt) {
      return (Reigster) super.setAlt(alt);
    }

    @Override
    public Reigster setFields(java.lang.String fields) {
      return (Reigster) super.setFields(fields);
    }

    @Override
    public Reigster setKey(java.lang.String key) {
      return (Reigster) super.setKey(key);
    }

    @Override
    public Reigster setOauthToken(java.lang.String oauthToken) {
      return (Reigster) super.setOauthToken(oauthToken);
    }

    @Override
    public Reigster setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (Reigster) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public Reigster setQuotaUser(java.lang.String quotaUser) {
      return (Reigster) super.setQuotaUser(quotaUser);
    }

    @Override
    public Reigster setUserIp(java.lang.String userIp) {
      return (Reigster) super.setUserIp(userIp);
    }
    ...
    public Reigster setRegId(java.lang.String regId) {
      this.regId = regId;
      return this;
    }

    @Override
    public Reigster set(String parameterName, Object value) {
      return (Reigster) super.set(parameterName, value);
    }
  }
